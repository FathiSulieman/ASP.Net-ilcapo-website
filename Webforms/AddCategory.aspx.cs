...
namespace Web_project
{
    public partial class AddCategory : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            string html = "<div style = \"  width: 40%; position: fixed; z-index: 1000; top:50%\" ><table border = \"1\" style = " + style + "><tr><td colspan =\"1\"></td><td>Category ID</td><td>Name</td></tr>";
        ...
        protected void btnAdd_Click(object sender, EventArgs e)
        {
            using (SqlConnection con = new SqlConnection(ConfigurationManager.ConnectionStrings["ConnectionString"].ConnectionString))
            {
                ...
                con.Open();
                SqlCommand cmd = new SqlCommand("Insert into tbl_Category(CatName) Values('" + txtNewCar.Text + "')", con);
                cmd.ExecuteNonQuery();

                Response.Write("<script> alert('Category Added Successfully ');  </script>");
                txtNewCar.Text = string.Empty;
