<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Contacts.aspx.cs" Inherits="Web_project.Contacts" %>
...
<meta http-equiv="Content-type" content="text/html; charset=utf-8" />
    ...
    <link href="Scripts/css/styleStore.css" rel="stylesheet" />
   ...
   <div id="navigation">
    ...
    <div class="dropdown-content">
      <a href="logout.aspx" style="width: 110px;}">Logout</a>
        ...
        <li><a href="Contacts.aspx" class="active" >Contact</a></li>
      </ul>
    </div>
    <!-- End Navigation -->
  </div>
  ...
  <div id="main">
    ...
    <div id="content">
      ...
      <div class="products">
        <div class="cl">&nbsp;</div>
        <ul>
          <li class="product"> <a href="https://facebook.com/"><img src="Scripts/css/images/contact2.png" alt="" style="margin-left: 19px;"/></a>
            <div class="product-info">
              <div class="product-desc">
                <p>facebook.com/IlCapo</p>
				</div>
            </div>
          </li>
		  <li class="product"> <a href="https://www.instagram.com/"><img src="Scripts/css/images/contact4.png" alt="" style="margin-left:19px;" /></a>
            <div class="product-info">
              <div class="product-desc">
                <p>Instagram.com/IlCapo</p>
				</div>
            </div>
          </li>
		  <li class="product"> <a href="https://twitter.com/?lang=en"><img src="Scripts/css/images/contact6.png" alt="" style="margin-left: 19px;"/></a>
            <div class="product-info">
              <div class="product-desc">
                <p>Twitter.com/IlCapo</p>
				</div>
            </div>
          </li>
		  <li class="product"> <a href="https://google.com/gmail/"><img src="Scripts/css/images/contact8.png" alt="" style="margin-left: 19px;"/></a>
            <div class="product-info">
              <div class="product-desc">
                <p>support@IlCapo.com</p>
				</div>
            </div>
          </li>
		  <li class="product"> <a href="https://web.whatsapp.com/"><img src="Scripts/css/images/contact10.png" alt="" style="margin-left: 19px;"/></a>
            <div class="product-info">
              <div class="product-desc">
                <p>+961 71 989 678</p>
				</div>
          ...
          <li class="product"> <a href="#"><img src="Scripts/css/images/contact12.png" alt="" style="margin-left: 19px;"/></a>
            <div class="product-info">
              <div class="product-desc">
                <p>+961 03 989 678</p>
				</div>
