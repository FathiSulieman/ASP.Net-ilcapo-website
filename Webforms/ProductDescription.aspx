<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ProductDescription.aspx.cs" Inherits="Web_project.ProductDescription" %>
...
<div class="shell">
  ...
  <div id="header">
   ...
   <div id="cart"> <a href="Cart.aspx" class="cart-link">Your Bag</a>
      <div class="cl">&nbsp;</div>
      <span>Items: 
          <asp:Label ID="TotalItems" runat="server" Text=""></asp:Label></span><br />
       <span>Price:<asp:Label ID="ToalPrice" runat="server" Text=""></asp:Label>$</span> 
	 </div>
    <!-- End Cart -->
    <!-- Navigation -->
    <div id="navigation">
  ...
  <div id="main">
    ...
    <ItemTemplate>
        <div style="height:300px; width:719px; border-style:solid; border-width:1px;">
              <div style="height:300px; width:200px; float:left; border-color: #838383;">
                  <img src='<%#Eval("PrImage")%>' alt="" height="300" width="200"/>

                  
              </div>
              <div style="  height: 300px; width: 395px; float: left; padding: 15px; line-height: 38px; ">
                  <h2 style="font-size: 26px;
    color: #ff3838;"><%#Eval("PrName") %></h2>

                  <h3 style="font-size:18px; 
    line-height: 30px;">$<%#Eval("PrPrice") %></h3><br />
                  

                  <p style="    border-top: solid 1px;
    border-bottom: solid 1px; border-color: #838383;" ><%#Eval("PrDescription") %></p><br /><br />
                 
                  <form id="form1" runat="server">
                      <asp:LinkButton ID="LinkButton1" runat="server" OnClick="AddToCart" Class="addToBag">Add to Bag</asp:LinkButton> </form>
...
<!-- End Shell -->
    ...
    <script>
        ...
        function AddtoCart() {
            window.location.href = "<%# "Cart.aspx?id=" + Eval("PID") + ""%>"; 
        }
